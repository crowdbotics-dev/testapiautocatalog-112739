...
## Project Structure
    ...
    ├── testapiautocatalog_112739  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112739`
...
2. Clone this repo and `cd testapiautocatalog_112739`
